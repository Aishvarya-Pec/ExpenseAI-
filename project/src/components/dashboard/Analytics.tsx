...
export const Analytics: React.FC<AnalyticsProps> = ({ expenses }) => {
  ...
  // Custom tooltip: payload shape can vary, so keep typing flexible
      ...
      return (
        <div className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-indigo-600 dark:text-indigo-400">
            Amount: ${typeof val === 'number' ? val.toFixed(2) : String(val)}
          </p>
        </div>
      );
    }
            ...
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
                  ...
                  fill="#8884d8"
                  dataKey="value"
                  // Provide a typed label function and guard percent before using toFixed
                  label={
                    isSmallScreen
                      ? false
                      : (data: any) => {
